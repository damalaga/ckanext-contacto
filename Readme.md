...
Para usar la extensión ckanext-contacto en CKAN 2.3 o superiores, deberá usar la rama master.
...
<b>NOTE:</b>
This extension works for CKAN 2.2 and above versiones.
If you want to use this extension for CKAN 2.3, you have to use master branch.
